...
function DoctorPhoto({ profile }) {
  return (
    <div className="aspect-[4/5] rounded-2xl overflow-hidden bg-teal/10 border border-line">
      {profile?.photo_url ? (
...
export default function Home() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-14">
      {/* Intro + photo, side by side on all screen sizes */}
      <div className="grid sm:grid-cols-[1fr,220px] lg:grid-cols-[1fr,380px] gap-8 items-start mb-12">
        <div>
      ...
      {/* Latest writing, full width below */}
      <div className="border-t border-line pt-8">
        <h2 className="font-display text-2xl font-semibold mb-6">Latest Writing</h2>
